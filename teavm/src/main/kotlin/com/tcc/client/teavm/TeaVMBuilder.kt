...
//            additionalAssetsClasspathFiles += "com/tcc/client/asset.extension"
        }
...
//        }
        ...
        // TeaReflectionSupplier.addReflectionClass("com.tcc.client.reflect")

        TeaBuilder.config(teaBuildConfiguration)
        val tool = TeaVMTool()

        // Usando WebAssembly (WASM) GC ao invés de JavaScript para melhor performance
        // WASM GC oferece melhor performance e é suportado por navegadores modernos
        // Nota: Debug pode ser um pouco mais difícil com WASM, mas ainda é suportado
        tool.targetType = TeaVMTargetType.WEBASSEMBLY_GC
        // Alternativa: Use JAVASCRIPT se preferir debugging mais fácil durante desenvolvimento
        // tool.targetType = TeaVMTargetType.JAVASCRIPT

        tool.mainClass = "com.tcc.client.teavm.TeaVMLauncher"
